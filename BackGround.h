...
public:
	...
	void GetBackground_One_pass(string srcfilename,string outputdir,unsigned int width,unsigned int height, cv::Size win_stride);
...
private:
	...
	void OutputBackground_OnePass(cv::Size win_stride);
